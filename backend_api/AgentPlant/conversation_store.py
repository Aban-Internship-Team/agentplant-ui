"""In-memory conversation store for AgentPlant.

Holds messages, session state, and final plant results for standalone runs.
Swap for a DB-backed store if you need multi-process persistence.
"""
